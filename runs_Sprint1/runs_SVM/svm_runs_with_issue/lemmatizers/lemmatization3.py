...
df_selected = pd.read_pickle('corpus_balanced2_cleaned_first_cut_scarce_elimination.pkl')
...
df_selected.to_csv("corpus_balanced_cleaned_lemmatized_first_cut_scarce_elimination.csv", index=False)
